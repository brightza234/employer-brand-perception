    ...
    <div className="space-y-10">
      <section>
        ...
        <p className="mt-1 text-sm text-foreground/60">
          ...
          views, and upload frequency (z-scored within this {scores.kols.length}-channel niche, not
          ...
          {(scores.weights.upload_frequency * 100).toFixed(0)}% frequency.
        </p>
        <div className="mt-4">
      ...
      <section>
        ...
        <div className="mt-4">
          <StatsPanel
            ...
            regression={scores.regression_engagement_on_size_and_frequency}
          />
        </div>
